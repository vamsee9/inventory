      ...
      <form className="mb-4" onSubmit={e => handleSubmit(e)}>
        ...
        <div className="form-row">
          <div className="form-group col-md-4">
            ...
            <input type="number" className="form-control" name="qty" placeholder="How many?" value={product.qty} onChange={e => handleChange(e)} />
          </div>
          ...
          <div className="form-group col-md-3">
            <label>Price</label>
            <input type="number" className="form-control" name="price" placeholder="How much?" value={product.price} onChange={e => handleChange(e)} />
          </div>
        </div>
        <label type="text" className="col-form-label" name="stock">{product.qty <= 40 && <p>low stock</p>}</label><br/>
